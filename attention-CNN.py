...
class FlickrDataset(Dataset):
    def __init__(self, root_dir, captions_file, choose_file, isTrain, transform=None, freq_threshold=2):
        ...
        if isTrain:
            validation_df = pd.read_csv('/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flickr8k_text/Flickr_8k.valImages.txt',
                                    names=['image'])
            self.choose_df = pd.concat([self.choose_df, validation_df]).reset_index()
        
        #self.choose_df = self.choose_df[:1000]
...
train_loader, dataset = get_loader(
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flicker8k_Images',
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flickr8k_text/Flickr8k.token.txt',
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flickr8k_text/Flickr_8k.trainImages.txt',
    transform=transform,
    num_workers=8,
    batch_size=batch_size,
    shuffle=True,
...
test_loader, test_dataset = get_loader(
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flicker8k_Images',
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flickr8k_text/Flickr8k.token.txt',
    '/mnt/hdd2/Laxmi/Mini-Project/Flickr8K/Flickr8k_text/Flickr_8k.testImages.txt',
    transform=transform,
    num_workers=8,
    shuffle=False,
    isTrain=False
